      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="banner_view.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="about_view.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="services.php">
                ...
                <span class="menu-title">Serveces</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="portfolio_view.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="counter_view.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="testimonial_view.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="brand_view.php">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="page-layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="pages/layout/boxed-layout.html">Reserved Dropdown</a></li>
